...
#   1. add_numbers — takes two floats and returns their sum.
#   2. subtract_numbers — takes two floats and returns their difference.
#
...
#   python server1_fastmcp_structured.py --port 3001 --log-level INFO
...
def main(port: int, log_level: str) -> None:
    ...
    # This schema validates inputs passed to the tools 
    # (e.g., {"a": 3.5, "b": 7.2})
    ...
    # This schema structures the tool's return value, 
    # providing both result and math expression
    ...
    # Decorator registers this function as a callable tool in the MCP server
    ...
    # === Register Tool: Subtract Numbers ===
